...
@section('section')
    <section class="py-5">
        ...
        <div class="row">
            ...
            <div id="Etarega" class="tabcontent col-lg-9 ps-lg-5">
                <h3 style="color:#2A6092">Entrega de llaves/mando</h3>
                <div>
                       <div style="text-align: center">
                        <p>Selecciona en el calendario el día y hora que quieres que Garer pase a entregarte las llaves/mando.</p>
                        <input type="date">
                       </div>
                        ...
                        <ul class="list-unstyled text-muted">
                         ...
                         <p>Selecciona la dirección donde Garer pasasá a entregarte las llaves/mando.</p>
                         <form action="{{route('entrega2')}}"
                            style="padding: 0px;
                                    margin-top: 0px;">
                                <input type="email" class="form-control mt-4" placeholder="Dirección" style="width:75%">
                                <input type="email" class="form-control mt-4" placeholder="Piso, planta, puerta"  style="width:75%">
                                ...
                                <div>
                                    <label class="mt-4">Añade un comentario...:</label>
