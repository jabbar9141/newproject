            ...
            <div id="Recogida" class="tabcontent col-lg-9 ps-lg-5">
                ...
                <div class="recogida2" style="margin: 20px;">
                    <div class="mt-4" style="text-align: center;">
                        <h6>¡Gracias! El personal de Garer pasará a recoger tus llaves/mando el <br> póximo miércoles 9 de Noviembre a las 12:00h.</h6>
                        <img src="{{asset('img/Captura-de-Pantalla.png')}}" alt="" width="200px" height="200px">
                    </div>
                    <div>
                        <h6 class="mt-4">Datos de recogida:</h6>
                        <form action="#"
                               style="padding: 0px;
                                margin-top: 0px;">
                             <label class="mt-2">Fecha de recogida</label>
                            <input type="email" class="form-control mt-2" placeholder="Jueves 9 de Noviembre" style="width:40%">
                            <label class="mt-2">Hora de recogida</label>
                            ...
                            <div>
                                <label class="mt-4">Comentarios para la recogida</label>
